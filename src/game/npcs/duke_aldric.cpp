...
void buildDukeDialogue(GameState& state)
{
    ...
    addNode(state, "duke_elena", "Duke Aldric",
        ...
        "\"But you did not come here to hear her praised. Tell me your concerns.\"",
        {
            ...
            {"I would like to invite her to dinner formally.", "duke_elena_invite",
                [](const GameState& gs) { return !gs.quest.invited_elena; },
                [](GameState& gs) { gs.quest.invited_elena = true; }},
    ...
    addNode(state, "duke_elena_code", "Duke Aldric",
        ...
        {
            {"Cedric intercepted a letter with an Iris seal.", "duke_elena_iris",
                [](const GameState& gs) { return gs.quest.elena_letters_found; },
                {}},
    ...
    addNode(state, "duke_evidence", "Duke Aldric",
        ...
        {
            {"I found letters connecting Elena to the Iris Consortium.", "duke_evidence_letters",
                [](const GameState& gs) { return gs.quest.elena_letters_found; },
                {}},
            {"Staff have reported Elena spreading rumors about us.", "duke_evidence_rumors",
                [](const GameState& gs) { return gs.quest.rumors_spread; },
                {}},
