...
void registerCaptainRoderick(GameState &state)
{
        ...
        n.associates = {"duke_aldric", "butler_graves", "maid_clara", "chef_marcel", "gardener_thorne", "cedric"};
        state.npcs[n.id] = n;
        ...
        addNode(state, "roderick_elena", "Elena",
                ...
                {{"\"Keep watching. Report anything suspicious.\"", "roderick_elena_watch", nullptr,
                  [](GameState &gs)
                  { gs.npcs["captain_roderick"].affection += 5; }},
                 {"\"I want you to... create a situation.\" (Risky)", "roderick_setup", nullptr,
                  [](GameState &gs)
                  { gs.npcs["captain_roderick"].suspicion += 8; }},
